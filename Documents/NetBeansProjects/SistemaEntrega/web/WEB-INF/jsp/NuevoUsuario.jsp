                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="btn-group-orizontal mt-0 text-white " >
                                <center>                                                             
                                    <a href="admin.htm" class="btn btn-dark rounded-pill "  role="button" aria-pressed="true">Regresar</a>│Registro de todos los usuarios al sistema                           
                                </center>
                            </div>
                        </div>                                        
                    </div>                  
                ...
                <div  class="d-flex">
                    ...
                    <div class="card-block col-sm-2 p-1">
                        <div class="card-body bg-dark ">                        
                            ...
                            <center><h5>Registrar usuarios</h5></center>
                            <div align="right" class=" p-1">
                             <!--   <a href="Agregar.htm" class="btn btn-danger btn-ms btn-block  active "role="button" aria-pressed="true" >   </a>     -->                      
                            </div>
                        </div>
                    </div>
