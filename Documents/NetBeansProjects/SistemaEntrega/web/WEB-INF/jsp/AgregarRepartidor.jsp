        ...
        <div class="container mt-4 col-lg-4 ">
            <div class="card border-info" style="max-width: 35rem; max-height: 100rem;">
                <div class="card-header   text-white "style="background-color:#A9CCE3 "> 
                    <center><h5 >Agregar nueva repartidor</h5>  </center>
                </div>
                <div class="card-body">
                    ...
                    <form method ="POST" class="needs-validation" novalidate>
                        ...
                        <input type="text" name="NombreR" class="form-control" required >

                            <Label  class="form-label">Telefono</label>
                        <input type="number" name="telefonoR" class="form-control col-sm-4 " required>

                        <Label  class="form-label" >Estatus </label>
                        <input type="text" name="EstatusR" class="form-control  col-sm-4 " required>
                        ...
                        <center>           
                            ...
                            <a href="Piloto.htm" class="btn btn-danger" >Cancelar</a>
                        </center>
                </div>
            </div>
            <!-- Modal -->
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    “Estimado Administrador se esta procesando la creacion de un nuevo repartidor ” 
