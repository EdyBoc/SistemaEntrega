        ...
        <div class="container mt-4 col-lg-4 ">
            <div class="card border-info" style="max-width: 35rem; max-height: 100rem;">
                <div class="card-header   text-white "style="background-color:#A9CCE3 "> 
                    <center><h5 >Mis entregas</h5>  </center>
                </div>
                <div class="card-body">
                    ...
                    <form method ="POST" class="needs-validation" novalidate >   
                        ...
                        <input type="text" name="idventa" class="form-control" value = "${lista[0].idventa}" >                           

                        <Label>Estado</label>
                        <input type="text" name="Estatus" class="form-control" value = "${lista[0].accion}" >

                        <Label  class="form-label" >Fecha</label>
                        <input type="date" name="EstatusR" class="form-control  col-sm-4 " required value = "${lista[0].Nombre}">
                        ...
                        <center>           
                            ...
                            <a href="miruta.htm" class="btn btn-danger" >Cancelar</a>
                        </center>
                </div>
            </div>
            <!-- Modal -->
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    “Proceso de estado finalizado ” 
                                    <center>  <button href="Miruta.htm" class="btn btn-warning " >Ok</button></center>
